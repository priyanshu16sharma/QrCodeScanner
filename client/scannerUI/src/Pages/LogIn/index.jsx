...
export default function SignInSide() {
    ...
    useEffect(() => {
        axios.post('http://localhost:8080/signIn', data)  // Assuming your backend is running on the same host
            .then(response => {
        ...
        <ThemeProvider theme={defaultTheme}>
            <Grid container component="main" sx={{ height: '100vh' }}>
                ...
                <Grid
                    ...
                    md={7}
                    sx={{
                        backgroundImage: 'url(https://www.barcoding.co.uk/wp-content/uploads/2022/03/QC-code-scanning-on-table.jpg)',
